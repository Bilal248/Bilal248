...
<p align="center">
  <a href="https://github.com/Bilal248"><img src="https://img.shields.io/github/followers/Bilal248?label=Follow&style=social" /></a>
</p>
...
I'm also the **Founder of Teekaala** (a mobile/software product) and the **Founder of Hameesh**, a software company. Building and scaling my own ventures alongside client and personal engineering projects is what drives me — I enjoy owning a product end-to-end, from idea to architecture to shipped code.
...
- **[Automated_Wheelchair](https://github.com/Bilal248/Automated_Wheelchair)** — Raspberry Pi and Arduino integration with AI implementation
- **[JEROTI](https://github.com/Bilal248/JEROTI)** — ML model for hardware architecture identification in HELIOS_OS
...
- **[carpooling](https://github.com/Bilal248/carpooling)** — City-to-city car pooling application
- **[CarPooling-Backend](https://github.com/Bilal248/CarPooling-Backend)** — Django backend for car pooling services

### 🍔 Food Delivery Ecosystem
- **[FoodDash-iOS](https://github.com/Bilal248/FoodDash-iOS)** — iOS client for food delivery platform
- **[FoodDash-Partner-Flutter](https://github.com/Bilal248/FoodDash-Partner-Flutter)** — Partner app for restaurant management
- **[FoodDash-Rider-Flutter](https://github.com/Bilal248/FoodDash-Rider-Flutter)** — Rider app for delivery management

### 🖥️ Systems & Operating Systems
- **[HELIOS_OS](https://github.com/Bilal248/HELIOS_OS)** — Custom OS that transforms itself for any hardware architecture
- **[OOP_Project](https://github.com/Bilal248/OOP_Project)** — Hotel management system with OOP principles

### 📊 Data Science & Analytics
- **[Local_Sport_Smart_System](https://github.com/Bilal248/Local_Sport_Smart_System)** — Smart system based on ontologies for local sports data
- **[PFAI_Project](https://github.com/Bilal248/PFAI_Project)** — Car data analysis in Pakistan
...
- **Focus Areas**: Mobile Development, AI/ML, Systems Programming, Web Development
...
- Love working on innovative projects that have real-world impact
- Always keen to mentor and share knowledge with the community
